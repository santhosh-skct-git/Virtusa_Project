...
const history= useHistory();
    return <div><Navbar id='adminnav' >
        ...
        <Container>
            ...
            <Nav.Link href="/category" style={{ color: 'white', marginRight: '35px',opacity:'1'}}>Category</Nav.Link>
            <Nav.Link href="/admin/addvehicle" style={{ color: 'white', marginRight: '35px',opacity:'1'}}>Add vehicle</Nav.Link>
